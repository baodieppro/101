...
@interface GSMultipleSwitchLayer : CALayer

@end

@implementation GSMultipleSwitchLayer
- (instancetype)init {
    if (self = [super init]) {
...
+ (Class)layerClass{
    return [GSMultipleSwitchLayer class];
}
...
-(void)setOnStatus:(BOOL)OnStatus{
    //图片切换
        if(OnStatus){
            ...
            if (self.selectedLeftColor) {
    //               self.backgroundColor=_selectedLeftColor;
                UIImageViewBack.backgroundColor=_selectedLeftColor;
               }
        }else{
            _OnStatus=YES;
            //滑块打开动画
            ...
            if (self.selectedRightColor) {
    //               self.backgroundColor=_selectedRightColor;
                UIImageViewBack.backgroundColor=_selectedRightColor;
               }
        }
...
-(void)setSelectedRightColor:(UIColor *)selectedRightColor{
    UIImageViewBack.backgroundColor=selectedRightColor;
    _selectedRightColor = selectedRightColor;
}
-(void)setSelectedLeftColor:(UIColor *)selectedLeftColor{
    _selectedLeftColor = selectedLeftColor;
}
